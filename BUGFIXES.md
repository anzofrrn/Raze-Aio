...
**Problem:** Error responses in slash commands had `"https://discord.gg/raze"` hardcoded directly in the file, completely ignoring the `config.links.supportServer` value.

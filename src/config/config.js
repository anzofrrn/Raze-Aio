...
export const config = {
  ...
  // External links
  links: {
    supportServer: process.env.SUPPORT_SERVER_URL || "https://discord.gg/raze"
  },

  // Bot presence/status configuration
  status: {
    name: process.env.STATUS_TEXT || '.help | Raze Bot',
  ...
  watermark: 'developed by Void & CodeZ development and design',

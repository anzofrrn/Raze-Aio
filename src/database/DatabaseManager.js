...
export class DatabaseManager {
  ...
  isGuildBlacklisted(guildId) { return this.guild.isGuildBlacklisted(guildId); }
  ...
  // ─── Guild Branding ──────────────────────────────────────────────────────────
  getBranding(guildId) { return this.guild.getBranding(guildId); }
  setBotNick(guildId, nick) { return this.guild.setBotNick(guildId, nick); }
  setBotBio(guildId, bio) { return this.guild.setBotBio(guildId, bio); }
  setBotAvatar(guildId, avatarUrl) { return this.guild.setBotAvatar(guildId, avatarUrl); }
